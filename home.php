<?php get_header(); ?>
    ...
    <script>(function ($) {
            $("#subscribe_button").on('click', function () {
                ...
                $.post('/blog/mch_subscr.php', { sMail: $input.val(), sToken: "8966307ae059e613f4599c8514c3d4b9d89bfe289ea33e561c35a025cd1d517a", uAct: '2', email: $("#emailFoot").val() }, function (data, textStatus) {
    ...
    <script type="text/javascript">(function jqIsReady_279() {
            if (typeof jQuery === "undefined") { setTimeout(jqIsReady_279, 100); } else {
                    ...
                    var wpfcWpfcAjaxCall = function (polls) {
                        if (polls.length > 0) {
                            ...
                            jQuery.ajax({
                                ...
                                dataType: "json",
                                data: { "action": "wpfc_wppolls_ajax_request", "poll_id": poll_id, "nonce": "e06e8dd226" },
                                cache: false,
